...
-- 2. Update students table to include class_id
...
-- 4. Update RLS policies for students table to include class context
...
-- 5. Create trigger for classes table
...
-- 6. Insert some default classes for testing
...
-- 7. Update existing students to be in the first class (if any exist)
UPDATE students 
SET class_id = (SELECT id FROM classes WHERE name = 'Web Development 101' LIMIT 1)
WHERE class_id IS NULL;

-- 8. Insert some default students for testing (if they don't exist)
